#' The mymlnorm function perform a maximum likelihood estimate for a normal experiment
#'
#' @param x -> Sample Data
#' @param mu -> Possible values of mu
#' @param sig -> Possible values of sigma
#'
#' @return A plot with maximum likelihood estimates graphically shown
#' @export
#'
...
#'
#' @examples
#' mymlnorm(x = c(12, 13, 15), mu = seq(12, 15, length.out = 100), sig = seq(1, 5, length.out = 100))
